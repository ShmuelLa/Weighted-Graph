...
public class TestRunner {
     ...
     */
    private static boolean checkPath(List<node_info> list, List<Integer> index) {
    ...
    public boolean equals(weighted_graph g0, weighted_graph g1) {
        boolean ans = false;
        ...
        if(g0.edgeSize() == g1.edgeSize() && g0.nodeSize() == g1.nodeSize()) {
            ...
            for(int i1=0;ans && i1<nodes1.length;i1++) {
                Collection<node_info> ni1 = g0.getV(nodes1[i1]);
                Collection<node_info> ni2 = g1.getV(nodes2[i1]);
                Iterator<node_info> it1 = ni1.iterator();
                Iterator<node_info> it2 = ni2.iterator();
                while(it1.hasNext() && it2.hasNext()) {
                    node_info n1 = it1.next();
                    node_info n2 = it2.next();
                    double w1 = g0.getEdge(nodes1[i1], n1.getKey());
                    double w2 = g1.getEdge(nodes2[i1], n2.getKey());
                    if(w1!=w2) {ans=false;}
                }
